...
\begin{itemize}
  \item \textbf{THREE.js:}
    \begin{itemize}
      ...
      con gráficos en 3D en el navegador web. Permite la creación y manipulación de escenas 3D, modelos tridimensionales, materiales, luces y cámaras.
  ...
  \item \textbf{XRControllerModelFactory.js:}
    \begin{itemize}
      ...
      personalizarse según las necesidades del proyecto.
      \item \textbf{Funcionalidades clave:}
      \begin{itemize}
  ...
  \item \textbf{OrbitControls.js:}
    \begin{itemize}
      ...
      en una escena 3D de manera interactiva. Permite rotar, acercar y alejar la vista de la escena, lo que mejora la experiencia de navegación.
      \item \textbf{Funcionalidades clave:}
      \begin{itemize}
